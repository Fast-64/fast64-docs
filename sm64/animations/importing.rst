...
To use an existing preset, use the search button next to the *"Preset"* dropdown.
    ...
    - To import a single animation, 
        disable it and then either select one of the preset animations using the search button or select *"Custom"* and choose an index.
